...
/// @nodoc
mixin _$CallState {
  List<model> get result => throw _privateConstructorUsedError;
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({required final List<model> result}) : _result = result;

  final List<model> _result;
  @override
  ...
  @override
  String toString() {
    return 'CallState(result: $result)';
  }
...
abstract class _Initial implements CallState {
  const factory _Initial({required final List<model> result}) = _$InitialImpl;
